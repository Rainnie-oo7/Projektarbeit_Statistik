...
plot_combined_balken(
    df_prim=df_prim,
    df_sec=df_sec,
    prim_start="Gesetzlich Anfang",
    prim_end="Gesetzlich Ende",
    sec_start="Gesetzlich Anfang",
    sec_end="Gesetzlich Ende",
    title="Ermittelte Wartezeiten für gesetzlich Versicherte"
)
